...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tblPreview.setGeometry(QtCore.QRect(20, 50, 661, 491))
        ...
        self.btnCalc.setGeometry(QtCore.QRect(700, 260, 291, 25))
        self.btnCalc.setObjectName("btnCalc")
        self.pbProgress = QtWidgets.QProgressBar(self.centralwidget)
        self.pbProgress.setGeometry(QtCore.QRect(700, 300, 291, 23))
        ...
        self.sbCycles = QtWidgets.QSpinBox(self.centralwidget)
        self.sbCycles.setGeometry(QtCore.QRect(830, 180, 48, 26))
        ...
        self.txtOutName.setGeometry(QtCore.QRect(830, 220, 141, 25))
        self.txtOutName.setObjectName("txtOutName")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(700, 220, 121, 25))
        self.label_6.setObjectName("label_6")
        self.lblEta = QtWidgets.QLabel(self.centralwidget)
        self.lblEta.setGeometry(QtCore.QRect(910, 340, 81, 20))
        ...
        self.lblEtaTitle.setGeometry(QtCore.QRect(700, 340, 171, 17))
        self.lblEtaTitle.setObjectName("lblEtaTitle")
        self.lblDuration = QtWidgets.QLabel(self.centralwidget)
        self.lblDuration.setGeometry(QtCore.QRect(910, 380, 81, 20))
        ...
        self.lblDurationTitle.setGeometry(QtCore.QRect(700, 380, 171, 17))
        ...
        MainWindow.setTabOrder(self.sbOffset, self.sbCycles)
        MainWindow.setTabOrder(self.sbCycles, self.txtOutName)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Duracion Ensayo"))
        self.label_4.setText(_translate("MainWindow", "Margen "))
        self.btnCalc.setText(_translate("MainWindow", "Calcular"))
        self.label_5.setText(_translate("MainWindow", "# Ciclos"))
