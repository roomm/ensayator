...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tblPreview.setGeometry(QtCore.QRect(20, 50, 661, 561))
        ...
        self.label_7.setGeometry(QtCore.QRect(950, 10, 41, 17))
        self.label_7.setObjectName("label_7")
        self.sbTotalEnsay = QtWidgets.QSpinBox(self.centralwidget)
        self.sbTotalEnsay.setGeometry(QtCore.QRect(830, 220, 48, 26))
        self.sbTotalEnsay.setObjectName("sbTotalEnsay")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(890, 140, 61, 25))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(890, 180, 61, 25))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(890, 220, 61, 25))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(700, 260, 121, 25))
        self.label_11.setObjectName("label_11")
        self.txtCycles = QtWidgets.QLineEdit(self.centralwidget)
        self.txtCycles.setGeometry(QtCore.QRect(830, 260, 61, 25))
        self.txtCycles.setObjectName("txtCycles")
        self.cbEnableRepetitions = QtWidgets.QCheckBox(self.centralwidget)
        self.cbEnableRepetitions.setGeometry(QtCore.QRect(700, 340, 92, 23))
        self.cbEnableRepetitions.setObjectName("cbEnableRepetitions")
        self.sbWaiting = QtWidgets.QSpinBox(self.centralwidget)
        self.sbWaiting.setEnabled(False)
        self.sbWaiting.setGeometry(QtCore.QRect(830, 380, 61, 26))
        self.sbWaiting.setMaximum(999)
        self.sbWaiting.setObjectName("sbWaiting")
        self.lblWaitingUnit = QtWidgets.QLabel(self.centralwidget)
        self.lblWaitingUnit.setEnabled(False)
        self.lblWaitingUnit.setGeometry(QtCore.QRect(900, 380, 61, 25))
        self.lblWaitingUnit.setObjectName("lblWaitingUnit")
        self.lblWaiting = QtWidgets.QLabel(self.centralwidget)
        self.lblWaiting.setEnabled(False)
        self.lblWaiting.setGeometry(QtCore.QRect(700, 380, 121, 25))
        self.lblWaiting.setObjectName("lblWaiting")
        self.lblRepetitions = QtWidgets.QLabel(self.centralwidget)
        self.lblRepetitions.setEnabled(False)
        self.lblRepetitions.setGeometry(QtCore.QRect(700, 420, 121, 25))
        self.lblRepetitions.setObjectName("lblRepetitions")
        self.sbRepetitions = QtWidgets.QSpinBox(self.centralwidget)
        self.sbRepetitions.setEnabled(False)
        self.sbRepetitions.setGeometry(QtCore.QRect(830, 420, 61, 26))
        self.sbRepetitions.setObjectName("sbRepetitions")
        self.label_12 = QtWidgets.QLabel(self.centralwidget)
        self.label_12.setGeometry(QtCore.QRect(700, 100, 121, 25))
        self.label_12.setObjectName("label_12")
        self.sbScale = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.sbScale.setGeometry(QtCore.QRect(830, 100, 69, 26))
        self.sbScale.setMaximum(99999.99)
        ...
        MainWindow.setTabOrder(self.cbSelectColumn, self.sbScale)
        MainWindow.setTabOrder(self.sbScale, self.sbDuration)
        MainWindow.setTabOrder(self.sbDuration, self.sbOffset)
        MainWindow.setTabOrder(self.sbOffset, self.sbTotalEnsay)
        MainWindow.setTabOrder(self.sbTotalEnsay, self.txtCycles)
        MainWindow.setTabOrder(self.txtCycles, self.txtOutName)
        MainWindow.setTabOrder(self.txtOutName, self.cbEnableRepetitions)
        MainWindow.setTabOrder(self.cbEnableRepetitions, self.sbWaiting)
        MainWindow.setTabOrder(self.sbWaiting, self.sbRepetitions)
        MainWindow.setTabOrder(self.sbRepetitions, self.btnCalc)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cbEnableRepetitions.setText(_translate("MainWindow", "Repetir "))
